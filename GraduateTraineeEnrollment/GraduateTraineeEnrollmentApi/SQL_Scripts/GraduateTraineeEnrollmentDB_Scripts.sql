...
GO
/****** Object:  StoredProcedure [dbo].[TraineeEnrollmentReport]    Script Date: 4/18/2024 6:13:40 PM ******/
...
GO
/****** Object:  Table [dbo].[Streams]    Script Date: 4/18/2024 6:13:40 PM ******/
DROP TABLE IF EXISTS [dbo].[Streams]
GO
/****** Object:  Table [dbo].[GraduateTrainees]    Script Date: 4/18/2024 6:13:40 PM ******/
DROP TABLE IF EXISTS [dbo].[GraduateTrainees]
GO
/****** Object:  Table [dbo].[Degrees]    Script Date: 4/18/2024 6:13:40 PM ******/
...
GO
/****** Object:  Table [dbo].[GraduateTrainees]    Script Date: 4/18/2024 6:13:41 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Streams]    Script Date: 4/18/2024 6:13:41 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
INSERT [dbo].[GraduateTrainees] ([GraduateTraineeId], [DegreeId], [StreamId], [TraineeName], [TraineeEmail], [UniversityName], [IsLastSemesterPending], [Gender], [DateOfApplication], [Image], [AI], [Phyton], [BusinessAnalysis], [MachineLearning], [Practical], [TotalMarks], [Percentages], [IsAdmisisonConfirmed]) VALUES (4, NULL, 1, N'Kashyap', N'kashyap@gmail.com', N'GTU', 1, N'f', CAST(N'2024-04-18' AS Date), N'string', CAST(80 AS Decimal(18, 0)), CAST(80 AS Decimal(18, 0)), CAST(80 AS Decimal(18, 0)), CAST(80 AS Decimal(18, 0)), CAST(80 AS Decimal(18, 0)), CAST(80 AS Decimal(18, 0)), CAST(80 AS Decimal(18, 0)), 1)
GO
...
GO
/****** Object:  StoredProcedure [dbo].[TraineeEnrollmentReport]    Script Date: 4/18/2024 6:13:41 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
